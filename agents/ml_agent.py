...
# NEW: Importing Decision Trees and Naive Bayes
...
def train_model(df, target_column):
    """
    This ML Agent tests 6 different algorithms, compares them, 
    ...
    # 5. Define the expanded arenas (Now with 6 models!)
    if is_category:
        models = {
        ...
        models = {
            ...
            "Decision Tree": DecisionTreeRegressor(random_state=42),   # NEW
            # Note: Naive Bayes is only for classification, so we skip it for regression
            "SVM": SVR(),
    ...
    # 7. Create a clean Pandas DataFrame report
